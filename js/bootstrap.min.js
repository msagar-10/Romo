!(function (e, t) {
  ...
  const f = {
    ...
    v = (i, n, e = !0) => {
      if (e) {
        ...
        const s = ({ target: e }) => {
          e === n &&
            ((t = !0), n.removeEventListener("transitionend", s), b(i));
        };
      ...
      off(i, s, e, t) {
        if ("string" == typeof s && i) {
          const [n, o, r] = I(s, e, t),
            ...
            c = s.startsWith(".");
          if (void 0 !== o)
            return l && l[r] ? void j(i, l, r, o, n ? e : null) : void 0;
          c &&
  ...
  class ee extends q {
    ...
    to(e) {
      ...
      if (!(e > this._items.length - 1 || e < 0))
        if (this._isSliding)
          P.one(this._element, "slid.bs.carousel", () => this.to(e));
        else {
    ...
    _keydown(e) {
      ...
      /input|textarea/i.test(e.target.tagName) ||
        ((t = J[e.key]) && (e.preventDefault(), this._slide(t)));
    }
    _getItemIndex(e) {
      return (
        (this._items =
  ...
  P.on(
    ...
    P.on(window, "load.bs.carousel.data-api", () => {
      ...
      for (let e = 0, t = i.length; e < t; e++)
        ee.carouselInterface(i[e], ee.getInstance(i[e]));
    }),
    e(ee);
    ...
    show() {
      if (!this._isTransitioning && !this._element.classList.contains("show")) {
        ...
        if (e) {
          ...
          if (((t = f ? se.getInstance(f) : null), t && t._isTransitioning))
            return;
        }
        if (!P.trigger(this._element, "show.bs.collapse").defaultPrevented) {
          e &&
            e.forEach((e) => {
              s !== e && se.collapseInterface(e, "hide"),
  ...
  function Te(e) {
    return "html" === ue(e)
      ? e
      : e.assignedSlot || e.parentNode || (ge(e) ? e.host : null) || Ae(e);
  }
  function Oe(e) {
  ...
  function Ce(e) {
    for (
      var t, i = fe(e), s = Oe(e);
      s &&
      ((t = s), 0 <= ["table", "td", "th"].indexOf(ue(t))) &&
      "static" === Ee(s).position;
    ...
    return (
      ((!s ||
        ("html" !== ue(s) &&
          ("body" !== ue(s) || "static" !== Ee(s).position))) &&
        (s ||
          (function (e) {
  ...
  function Pe(e) {
      ...
      c =
        !0 === l
          ? ((f = n.x),
            ...
            { x: De(De(f * m) / m) || 0, y: De(De(p * m) / m) || 0 })
          : "function" == typeof l
          ? l(n)
          : n,
      h = c.x,
    ...
    a &&
      ...
      (u = "clientWidth"),
      (n = Ce(t)) === fe(t) &&
        "static" !== Ee((n = Ae(t))).position &&
        ((c = "scrollHeight"), (u = "scrollWidth")),
      s === ne && ((l = oe), (e -= n[c] - i.height), (e *= r ? 1 : -1)),
      s === ae && ((m = re), (d -= n[u] - i.width), (d *= r ? 1 : -1)));
  ...
  function Ye(e, t) {
    return "viewport" === t
      ? Xe(
          ...
          { width: l, height: c, x: o + $e(n), y: r })
        )
      : me(t)
      ? (((s = ve((i = t))).top = s.top + i.clientTop),
      ...
      : Xe(
          ...
          (n = -t.scrollLeft + $e(n)),
          (t = -t.scrollTop),
          "rtl" === Ee(s || r).direction &&
            (n += Le(r.clientWidth, s ? s.clientWidth : 0) - e),
          { width: e, height: i, x: n, y: t })
        );
    var i, s, n, o, r, a, l, c;
  }
  function Qe(e) {
  ...
  function Ze(e, t) {
    var i,
      ...
      u =
        ((i = pe(u) ? u : u.contextElement || Ae(e.elements.popper)),
        (l = d),
        (u =
          "clippingParents" === (u = c)
            ? ((c = Ke(Te((d = i)))),
              pe(
                (s =
                  0 <= ["absolute", "fixed"].indexOf(Ee(d).position) && me(d)
                    ? Ce(d)
                    : d)
              )
                ? c.filter(function (e) {
        ...
        ((l = u.reduce(function (e, t) {
          t = Ye(i, t);
          return (
            (e.top = Le(t.top, e.top)),
            (e.right = xe(t.right, e.right)),
            (e.bottom = xe(t.bottom, e.bottom)),
            (e.left = Le(t.left, e.left)),
            e
          );
        }, Ye(i, l))).width = l.right - l.left),
        (l.height = l.bottom - l.top),
        (l.x = l.left),
        (l.y = l.top),
        l),
      l = ve(o),
      o = Ge({ reference: l, element: h, strategy: "absolute", placement: a }),
              ...
              return e.concat(
                "auto" === be(t)
                  ? ((i = d),
                    ...
                    (a = n.padding),
                    (s = n.flipVariations),
                    (l = void 0 === (n = n.allowedAutoPlacements) ? he : n),
                    (c = Qe(e)),
                    (e = c
                      ? s
                        ? ce
  ...
  var it = {
      ...
      fn: function (e) {
        var t = e.state,
          ...
          r = Ze(t, { elementContext: "reference" }),
          e = Ze(t, { altBoundary: !0 }),
          s = et(r, s),
          e = et(e, n, o),
          n = tt(s),
          o = tt(e);
                ...
                (n =
                  (n = (i =
                    "function" == typeof n
                      ...
                      : n)[0]) || 0),
                (i = ((i = i[1]) || 0) * t),
                0 <= [ae, re].indexOf(o) ? { x: i, y: n } : { x: n, y: i })),
              e
            );
            var i, s, n, o;
          }, {}),
      ...
      fn: function (e) {
        ...
        E &&
          ((o || a) &&
            ...
            (m = "start" === b ? -e[u] : -A[u]),
            (b = t.elements.arrow),
            (e = f && b ? ye(b) : { width: 0, height: 0 }),
            (p = (b = t.modifiersData["arrow#persistent"]
              ? t.modifiersData["arrow#persistent"].padding
              : { top: 0, right: 0, bottom: 0, left: 0 })[p]),
            (c = b[c]),
            (e = Se(0, A[u], e[u])),
            (p = v ? A[u] / 2 - h - e - p - n : _ - e - p - n),
            (e = v ? -A[u] / 2 + h + e + c + n : m + e + c + n),
            (n = (c = t.elements.arrow && Ce(t.elements.arrow))
              ? "y" === y
                ? c.clientTop || 0
                : c.clientLeft || 0
              : 0),
            ...
            (c = E[y] + e - c),
            o &&
              ((d = Se(f ? xe(l, n) : l, i, f ? Le(d, c) : d)),
              (E[y] = d),
              (r[y] = d - i)),
            a &&
              ((a = (i = E[w]) + g["x" === y ? ne : ae]),
              (y = i - g["x" === y ? oe : re]),
              (y = Se(f ? xe(a, n) : a, i, f ? Le(y, c) : y)),
              (E[w] = y),
              (r[w] = y - i))),
          (t.modifiersData[s] = r));
      },
  ...
  var ct = lt(),
    ht = lt({ defaultModifiers: [Be, nt, He, _e] }),
    dt = lt({ defaultModifiers: [Be, nt, He, _e, st, Je, ot, je, it] }),
    ut = Object.freeze({
      __proto__: null,
      popperGenerator: lt,
      detectOverflow: Ze,
    ...
    static dataApiKeydownHandler(e) {
      if (
        ...
        if (
          ...
          return "Escape" === e.key
            ? (i().focus(), void Et.clearMenus())
            : "ArrowUp" === e.key || "ArrowDown" === e.key
            ? (t || i().click(), void Et.getInstance(i())._selectMenuItem(e))
  ...
  P.on(
    ...
    P.on(document, "click.bs.dropdown.data-api", Et.clearMenus),
    P.on(document, "keyup.bs.dropdown.data-api", Et.clearMenus),
    P.on(
      document,
  ...
  class Ct {
    ...
    _getConfig(e) {
      return (
        ((e = { ...Tt, ...("object" == typeof e ? e : {}) }).rootElement = c(
          e.rootElement
        )),
        i("backdrop", e, Ot),
        e
    ...
    show() {
      ...
      if (this.isWithContent() && this._isEnabled) {
        ...
        if (!t.defaultPrevented && s) {
          ...
          R(n, this.constructor.DATA_KEY, this),
            this._element.ownerDocument.documentElement.contains(this.tip) ||
              (r.appendChild(n),
              P.trigger(this._element, this.constructor.Event.INSERTED)),
            this._popper
              ? this._popper.update()
              : (this._popper = dt(this._element, n, this._getPopperConfig(e))),
  ...
  P.on(
    ...
    function (e) {
      ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
        h(this) || Zt.getOrCreateInstance(this).show();
    }
  ),
    e(Zt);
